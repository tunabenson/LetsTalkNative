  ...
  return (
    ...
    >
      <View className="flex-1 justify-center items-center bg-primarycolor-4 p-4">
        ...
        <Text style={{fontFamily:'Amiri'}} className="text-white text-3xl mb-8 font-semibold">Reset Password</Text>
        ...
        >
          {loading ? (
            <Text style={{fontFamily:'Amiri'}} className="text-primarycolor-4 font-bold">Sending...</Text>
          ) : (
            <Text style={{fontFamily:'Amiri'}} className="text-primarycolor-4 font-bold">Submit</Text>
          )}
        </TouchableOpacity>
      </View>
    </KeyboardAvoidingView>
