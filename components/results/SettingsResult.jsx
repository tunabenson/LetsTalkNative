...
function SettingsResult({ name, component, icon }) {
  ...
  return (
    ...
    >
      ...
      <Text style={{fontFamily:'Amiri'}} className="text-2xl font-semibold text-gray-700">{name}</Text>
      ...
      {isFocused && (
        ...
        >
          <Text style={{fontFamily:'Amiri'}} className="text-black mt-6 ml-3 text-xl text-left">Close</Text>
        </TouchableOpacity>
